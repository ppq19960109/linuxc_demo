...
def Switch_All_down(inValue, valueLen):
    cmdId = '-1'
    payloadLen = 0
...
def Switch_1_up(inValue, valueLen):
...
def Switch_1_down(inValue, valueLen):
    cmdId = '-1'
    payloadLen = 0
    if inValue == STRING_HY_SWITHC_OFF:
        cmdId = STRING_Z3_SWITHC_OFF  # 关闭
...
def Switch_2_up(inValue, valueLen):
    if inValue == STRING_Z3_SWITHC_OFF:
        inValue = STRING_HY_SWITHC_OFF
        valueLen = 1
    else:
...
def Switch_2_down(inValue, valueLen):
    cmdId = '-1'
    payloadLen = 0
    if inValue == STRING_HY_SWITHC_OFF:
        cmdId = STRING_Z3_SWITHC_OFF  # 关闭
...
def Switch_3_up(inValue, valueLen):
    if inValue == STRING_Z3_SWITHC_OFF:
        inValue = STRING_HY_SWITHC_OFF
        valueLen = 1
    else:
...
def Switch_3_down(inValue, valueLen):
    cmdId = '-1'
    payloadLen = 0
    if inValue == STRING_HY_SWITHC_OFF:
        cmdId = STRING_Z3_SWITHC_OFF  # 关闭
