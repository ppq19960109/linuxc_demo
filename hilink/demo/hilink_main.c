...
int main(void)
{
  ...
  printf("sdk attr deviceMainTaskStackSize:%d\n", sdkAttr->deviceMainTaskStackSize);
  printf("sdk attr bridgeMainTaskStackSize:%d\n", sdkAttr->bridgeMainTaskStackSize);
  printf("sdk attr otaCheckTaskStackSize:%d\n", sdkAttr->otaCheckTaskStackSize);
  printf("sdk attr otaUpdateTaskStackSize:%d\n", sdkAttr->otaUpdateTaskStackSize);

  sdkAttr->bridgeMainTaskStackSize*=2;
