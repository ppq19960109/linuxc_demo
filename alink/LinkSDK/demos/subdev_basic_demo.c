...
/* TODO: 替换为自己网关设备的三元组 */
/* Notice: 下述三元组只是拿来demo, 不能拿来做用户业务, 不要上传用户自己的数据 */
char *product_key       = "a1tmc66UyDK";
char *device_name       = "gateway_demo_dev";
char *device_secret     = "90e2d8e327b0641b7654f5d3ef94acdd";
...
*/
char  *mqtt_host = "a1tmc66UyDK.iot-as-mqtt.cn-shanghai.aliyuncs.com";
...
int main(int argc, char *argv[])
{
    ...
    /*
    {
        char *sub_topic = "/a13FN5TplKq/subdev_basic_demo_01/user/get";
    ...
    */
    ...
    /*
    {
        char *pub_topic = "/sys/a13FN5TplKq/subdev_basic_demo_01/thing/event/property/post";
    ...
    */
    ...
    /*
    {
        char *pub_topic = "/sys/a1tmc66UyDK/gateway_demo_dev/thing/event/property/post";
