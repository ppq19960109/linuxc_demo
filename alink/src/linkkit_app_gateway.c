...
int main_close(void)
{
    ...
    cloudLinkClose();
    HAL_SleepMs(1000);
    // EXAMPLE_TRACE("IOT_Linkkit_Close start");
    // for(int i=1;i<user_example_ctx->subdev_index;i++)
    // {
    //     IOT_Linkkit_Close(i);
    // }
    // IOT_Linkkit_Close(user_example_ctx->master_devid);
    // EXAMPLE_TRACE("IOT_Linkkit_Close end");
...
{
    sync();
    EXAMPLE_TRACE("linkkit_ota_install......");
    main_close();
