...
/*
    pstAwbSnsDft->au16GainOffset[0] = 0x1D7;
    pstAwbSnsDft->au16GainOffset[1] = 0x100;
    pstAwbSnsDft->au16GainOffset[2] = 0x100;
    pstAwbSnsDft->au16GainOffset[3] = 0x1C5;

    pstAwbSnsDft->as32WbPara[0] = -59;
    pstAwbSnsDft->as32WbPara[1] = 315;
    pstAwbSnsDft->as32WbPara[2] = 0;
    pstAwbSnsDft->as32WbPara[3] = 166718;
    pstAwbSnsDft->as32WbPara[4] = 128;
    pstAwbSnsDft->as32WbPara[5] = -115245;*/
...
static HI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, HI_U8 u8Mode)
{
    ...
    switch (u8Mode)
    {
        ...
        case WDR_MODE_2To1_FRAME:
            ...
            g_astimx327State[ViPipe].u8Hcg = 0x2;
            ISP_TRACE(HI_DBG_ERR, "2to1 half-rate frame WDR mode\n");
            break;
        ...
        case WDR_MODE_2To1_LINE:
            ...
            if (IMX327_SENSOR_1080P_30FPS_WDR_2to1_MODE == pstSnsState->u8ImgMode)
            {
                ...
                ISP_TRACE(HI_DBG_ERR, "2to1 line WDR 1080p mode(60fps->30fps)\n");
            }
            break;
        default:
