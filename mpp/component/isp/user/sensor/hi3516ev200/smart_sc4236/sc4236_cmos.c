...
#define SC4236_FULL_LINES_MAX   (0xFFFF)
...
static HI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    switch (pstSnsState->enWDRMode)
    {
        ...
        case WDR_MODE_NONE:   /*linear mode*/
            ...
            pstAeSnsDft->u32MaxDgain = 1240;//31744;
                                       ...
                                       AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    u32FullLines = (u32FullLines > SC4236_FULL_LINES_MAX) ? SC4236_FULL_LINES_MAX : u32FullLines;
...
static HI_U32 again_table[64] =
{
    ...
    0x1c10, 0x1c11, 0x1c12, 0x1c13, 0x1c14, 0x1c15, 0x1c16, 0x1c17, 0x1c18, 0x1c19, 0x1c1a, 0x1c1b, 0x1c1c, 0x1c1d,
    0x1c1e, 0x1c1f
};
...
static HI_VOID cmos_gains_update(VI_PIPE ViPipe, HI_U32 u32Again, HI_U32 u32Dgain)
{
    ...
    {
        pstSnsState->astRegsInfo[0].astI2cData[11].u32Data = 0x1e;
        pstSnsState->astRegsInfo[0].astI2cData[12].u32Data = 0x23;
        pstSnsState->astRegsInfo[0].astI2cData[13].u32Data = 0x80;
        pstSnsState->astRegsInfo[0].astI2cData[14].u32Data = 0xf6;
    }
    ...
    {
        pstSnsState->astRegsInfo[0].astI2cData[11].u32Data = 0x50;
        pstSnsState->astRegsInfo[0].astI2cData[12].u32Data = 0x44;
        pstSnsState->astRegsInfo[0].astI2cData[13].u32Data = 0x82;
        pstSnsState->astRegsInfo[0].astI2cData[14].u32Data = 0x16;
    }
...
static HI_S32 cmos_get_awb_default(VI_PIPE ViPipe, AWB_SENSOR_DEFAULT_S *pstAwbSnsDft)
{
    ...
    pstAwbSnsDft->au16GainOffset[0] = 0x16D;
    pstAwbSnsDft->au16GainOffset[1] = 0x100;
    pstAwbSnsDft->au16GainOffset[2] = 0x100;
    pstAwbSnsDft->au16GainOffset[3] = 0x162;

    pstAwbSnsDft->as32WbPara[0] = 16;
    pstAwbSnsDft->as32WbPara[1] = 240;
    pstAwbSnsDft->as32WbPara[2] = 0;
    pstAwbSnsDft->as32WbPara[3] = 228233;
    pstAwbSnsDft->as32WbPara[4] = 128;
    pstAwbSnsDft->as32WbPara[5] = -178320;
...
static HI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_REGS_INFO_S *pstSnsRegsInfo)
{
    ...
    if ((HI_FALSE == pstSnsState->bSyncInit) || (HI_FALSE == pstSnsRegsInfo->bConfig))
    {
        ...
        pstSnsState->astRegsInfo[0].astI2cData[11].u32RegAddr = 0x3301;
        pstSnsState->astRegsInfo[0].astI2cData[12].u8DelayFrmNum = 1;
        pstSnsState->astRegsInfo[0].astI2cData[12].u32RegAddr = 0x3633;
        pstSnsState->astRegsInfo[0].astI2cData[13].u8DelayFrmNum = 1;
        pstSnsState->astRegsInfo[0].astI2cData[13].u32RegAddr = 0x3630;
        pstSnsState->astRegsInfo[0].astI2cData[14].u8DelayFrmNum = 1;
        pstSnsState->astRegsInfo[0].astI2cData[14].u32RegAddr = 0x3622;
    ...
    else
    {
        ...
        if ( HI_TRUE == (pstSnsState->astRegsInfo[0].astI2cData[0].bUpdate\
