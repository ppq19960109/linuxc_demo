...
{
    IOWR_8DIRECT(VREG_AF_BASE(ViPipe) + 0x00e0, (data & 0x03));
}
static __inline HI_U8 hi_ext_system_af_enable_read(VI_PIPE ViPipe)
{
    return (IORD_8DIRECT(VREG_AF_BASE(ViPipe) + 0x00e0) & 0x03);
}
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
#define HI_EXT_SYSTEM_DEMOSAIC_MANUAL_NONDIRECTION_MIDFREQ_DETAILENHANCE_STRENGTH_LINEAR_DEFAULT (32)
