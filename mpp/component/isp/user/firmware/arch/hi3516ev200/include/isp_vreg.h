...
//#define ISP_BNR_RLSC_LUT_WSTT_OFFSET  (ISP_OFFSETOF(S_ISP_LUT_WSTT_TYPE,ISP_MLSC_LUT_WSTT     ))
...
//#define ISP_DPC_LUT_WSTT_OFFSET       (ISP_OFFSETOF(S_ISP_LUT_WSTT_TYPE,ISP_DPC_LUT_WSTT     ))
