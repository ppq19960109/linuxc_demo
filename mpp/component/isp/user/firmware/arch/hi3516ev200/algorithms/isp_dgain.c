...
static HI_VOID FeDgDynaInit(VI_PIPE ViPipe, ISP_DG_DYNA_CFG_S *pstDynaRegCfg)
{
    pstDynaRegCfg->u32ClipValue  = 0xFFFFF;
    pstDynaRegCfg->u16GainR      = 0x100;
    pstDynaRegCfg->u16GainGR     = 0x100;
                 ...
                 HI_VOID *pRegCfg, HI_S32 s32Rsv)
{
    ...
    pstRegCfg->stAlgRegCfg[0].stFeDgRegCfg.stDynaRegCfg.u16GainR  = u32IspDgain;
    pstRegCfg->stAlgRegCfg[0].stFeDgRegCfg.stDynaRegCfg.u16GainGR = u32IspDgain;
    pstRegCfg->stAlgRegCfg[0].stFeDgRegCfg.stDynaRegCfg.u16GainGB = u32IspDgain;
    pstRegCfg->stAlgRegCfg[0].stFeDgRegCfg.stDynaRegCfg.u16GainB  = u32IspDgain;
    pstRegCfg->stAlgRegCfg[0].stFeDgRegCfg.stDynaRegCfg.bResh     = HI_TRUE;
