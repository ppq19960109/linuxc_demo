...
static HI_VOID CscDynaRegsConfig(ISP_CSC_ATTR *pstCscAttr, ISP_CSC_DYNA_CFG_S *pstDynaRegCfg)
{
    ...
    pstDynaRegCfg->s16CscInDC0  = pstCscAttr->as16CSCIdc[0] << 2;
    pstDynaRegCfg->s16CscInDC1  = pstCscAttr->as16CSCIdc[1] << 2;
    pstDynaRegCfg->s16CscInDC2  = pstCscAttr->as16CSCIdc[2] << 2;

    pstDynaRegCfg->s16CscOutDC0 = pstCscAttr->as16CSCOdc[0] << 2;
    pstDynaRegCfg->s16CscOutDC1 = pstCscAttr->as16CSCOdc[1] << 2;
    pstDynaRegCfg->s16CscOutDC2 = pstCscAttr->as16CSCOdc[2] << 2;
