...
{
    HI_BOOL bDynaResh;
    //HI_BOOL bStrengthWrite; // Strength write control
...
/*---------------Rgbir Register Configure Start--------------------*/
typedef struct hiISP_RGBIR_USR_CFG_S
{
    ...
    //HI_S16  s16Matrix0;  //s15.0
    //HI_S16  s16Matrix1;  //s15.0
    //HI_S16  s16Matrix2;  //s15.0
    //HI_S16  s16Matrix3;  //s15.0
    //HI_S16  s16Matrix4;  //s15.0
    //HI_S16  s16Matrix5;  //s15.0
    //HI_S16  s16Matrix6;  //s15.0
    //HI_S16  s16Matrix7;  //s15.0
    //HI_S16  s16Matrix8;  //s15.0
    //HI_S16  s16Matrix9;  //s15.0
    //HI_S16  s16Matrix10; //s15.0
    //HI_S16  s16Matrix11; //s15.0
...
typedef struct hiISP_BE_BLC_CFG_S
{
    ...
    //ISP_BLC_REG_CFG_S stFlickerBlc[4];
    //ISP_BLC_REG_CFG_S stPreGammaBlc;
    //ISP_BLC_REG_CFG_S stSplitBlc;
...
typedef struct hiISP_ALG_REG_CFG_S
{
    ...
    ISP_DG_REG_CFG_S             stFeDgRegCfg;
    ISP_AWB_REG_CFG_S            stAwbRegCfg;

    //ISP_AF_REG_CFG_S             stFEAfRegCfg;
