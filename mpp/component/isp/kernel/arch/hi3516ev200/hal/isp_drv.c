...
HI_S32 ISP_DRV_FeRemap(void)
{
    ...
    for (ViPipe = 0; ViPipe < ISP_MAX_PHY_PIPE_NUM; ViPipe++)
    {
        ...
        if (HI_NULL == reg_vicap_ch_base_va[ViPipe])
        {
    ...
    for (ViPipe = 0; ViPipe < ISP_MAX_PIPE_NUM; ViPipe++)
    {
        ...
        //g_astIspDrvCtx[ViPipe].stIspBeSyncPara.au32WDRWBGain[0] = 0x1EB;
        //g_astIspDrvCtx[ViPipe].stIspBeSyncPara.au32WDRWBGain[1] = 0x100;
        //g_astIspDrvCtx[ViPipe].stIspBeSyncPara.au32WDRWBGain[2] = 0x100;
        //g_astIspDrvCtx[ViPipe].stIspBeSyncPara.au32WDRWBGain[3] = 0x1CA;
...
HI_S32 ISP_DRV_FE_AE_Global_StatisticsRead(ISP_STAT_S *pstStat, S_ISP_FE_STT_REGS_TYPE *pstFeSttReg, HI_U32 k)
{
    ...
    {
        j = i * 4;
        pstStat->stFEAeStat1.au32HistogramMemArray[k][j] = pstFeSttReg->ISP_AE_HIST[i].u32;//pstFeReg->ISP_AE1_HIST_RDATA.u32;
