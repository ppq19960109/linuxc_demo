...
HI_U8 ISP_DRV_GetBeSyncIndex(ISP_DRV_CTX_S *pstDrvCtx)
{
    ...
    else
    {
        if (FRAME_INTERRUPT_START == pstDrvCtx->stFrameIntAttr.enIntType)
        {
            ...
            {
                index = pstDrvCtx->stSyncCfg.u8Cfg2VldDlyMAX + 2;
            }
            else
            {
                index = pstDrvCtx->stSyncCfg.u8Cfg2VldDlyMAX + 1;
...
HI_S32 ISP_DRV_RegConfigIsp(VI_PIPE ViPipe, ISP_DRV_CTX_S *pstDrvCtx)
{
    ...
    if (IS_WDR_MODE(pstDrvCtx->stSyncCfg.u8WDRMode))
    {
        ...
        for (i = 0; i < 3; i++)
        {
            u32Ratio[i] = pstDrvCtx->stSyncCfg.u32ExpRatio[i][u8SyncIndex];
        }

        /* Cal CfgNodeIdx to ispDgain/ratio.. configs */
        u8CfgNodeIdx = (u8SyncIndex / DIV_0_TO_1(pstDrvCtx->stSyncCfg.u8VCNumMax + 1));
        u8CfgNodeVC  = (u8SyncIndex % DIV_0_TO_1(pstDrvCtx->stSyncCfg.u8VCNumMax + 1));
    }
    else
    {
    ...
    u8WdrIndex = u8SyncIndex;

    for (i = 0; i < 4; i++)
    {
        au32WDRGain[i] = pstDrvCtx->stSyncCfg.u32WDRGain[i][u8WdrIndex];
...
static long ISP_ioctl(unsigned int cmd, unsigned long arg, void *private_data)
{
    ...
    switch (cmd)
    {
        ...
        case ISP_GET_VD_TIMEOUT:
        {
            ...
            pstVdTimeOut = (ISP_VD_TIMEOUT_S *)arg;
        ...
        case ISP_UPDATE_INFO_SET:
        {
            ...
            pstDrvCtx = ISP_DRV_GET_CTX(ViPipe);
            pstIspUpdateInfo = (ISP_DCF_UPDATE_INFO_S *)arg;
        ...
        case ISP_DNG_INFO_SET:
        {
            ...
            pstDngImgDynInfo = (DNG_IMAGE_DYNAMIC_INFO_S *)arg;
        ...
        case ISP_DNG_INFO_GET:
        {
            ...
            pstDngStaticInfo = (DNG_IMAGE_STATIC_INFO_S *)arg;
        ...
        case ISP_TRANS_BUF_INIT :
        {
            ...
            pstTransInfo = (ISP_TRANS_INFO_BUF_S *)arg;
        ...
        case ISP_PRO_BUF_INIT :
        {
            ...
            pstProInfo = (ISP_PRO_INFO_BUF_S *)arg;
        ...
        case ISP_STAT_BUF_PUT :
        {
            ...
            pstStatInfo = (ISP_STAT_INFO_S *)arg;
        ...
        case ISP_REG_CFG_SET:
        {
            ...
            pstRegKernelCfg = (ISP_KERNEL_REG_CFG_S *)arg;
        ...
        case ISP_SYNC_INIT_SET:
        {
            ...
            if (HI_TRUE == pstDrvCtx->stStitchAttr.bStitchEnable)
            {
                pstDrvCtx->bStitchSync = *(HI_BOOL *)arg;
            }
        ...
        case ISP_CONFIG_INFO_SET:
        {
            ...
            pstIspConfigInfo = (ISP_CONFIG_INFO_S *)arg;
        ...
        case ISP_GET_FUSION_ATTR:
        {
            ...
            pstFusionAttr = (VI_FUSION_GROUP_S *)arg;
        ...
        case ISP_CLUT_BUF_GET:
        {
            ...
            *(HI_U64 *)arg = g_astIspDrvCtx[ViPipe].stClutBufAttr.stClutBuf.u64PhyAddr;
        ...
        {
            return ISP_DRV_YUVRunOnceInfo(ViPipe, (HI_BOOL *)arg);
        }
        ...
        case ISP_BE_LUT_STT_BUF_GET:
        {
            ...
            *(HI_U64 *)arg = g_astIspDrvCtx[ViPipe].stBeLut2SttAttr.astBeLutSttBuf[0].astLutSttBuf[0].u64PhyAddr;
        ...
        case ISP_SPECAWB_BUF_GET:
        {
            ...
            *(HI_U64 *)arg = g_astIspDrvCtx[ViPipe].stSpecAwbBufAttr.stSpecAwbBuf.u64PhyAddr;
        ...
        {
            ISP_CHECK_PIPE(ViPipe);
            g_astIspDrvCtx[ViPipe].enIspRgbirFormat = *(HI_U32 *)arg;
            return HI_SUCCESS;
        }
        default:
        {
