...
HI_VOID SAMPLE_AUDIO_Usage(HI_VOID)
{
    ...
    printf("\t0:  start AI to AO loop (stereo, not support Hi3516EV200)\n");
    printf("\t1:  send audio frame to AENC channel from AI, save them (stereo, not support Hi3516EV200)\n");
    printf("\t2:  read audio stream from file, decode and send AO (stereo, not support Hi3516EV200)\n");
