...
HI_S32 HI_SCENE_SetStaticAE(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticAE\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticWDRExposure(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticWDRExposure\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticFSWDR(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticFSWDR\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticAWB(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticAWB\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticAWBEX(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticAWBEX\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticSaturation(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticSaturation\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticCCM(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticCCM\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticGlobalCac(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticGlobalCac\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticDRC(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticDRC\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticLDCI(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticLDCI\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticDeHaze(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticDeHaze\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticCSC(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticCSC\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticNr(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticNr\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticShading(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticShading\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticSharpen(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticSharpen\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticCA(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticCA\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticCrosstalk(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticCrosstalk\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetStaticClut(VI_PIPE ViPipe, HI_U8 u8Index)
{
    ...
    {
        printf("Do not set HI_SCENE_SetStaticClut\n");
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_SetDynamicFps(VI_PIPE ViPipe, HI_U64 u64Exposure, HI_U64 u64LastExposure, HI_U8 u8Index)
{
    ...
    static HI_U32 u32LastExpLevelLtH = 0;
    static HI_U32 u32LastExpLevelHtL = 1;
    HI_U32 u32ExpLevel = 0;
    HI_S32 s32Ret = HI_SUCCESS;
    ISP_PUB_ATTR_S stPubAttr;
    ISP_EXPOSURE_ATTR_S stExposureAttr;
    ...
    if(u64Exposure > u64LastExposure)
    {
        ...
        if(u32ExpLevel == u32LastExpLevelLtH)
    {
        return HI_SUCCESS;
    }
    else
    {
            ...
            s32Ret = HI_MPI_ISP_GetPubAttr(ViPipe, &stPubAttr);
            CHECK_SCENE_RET(s32Ret);
            stPubAttr.f32FrameRate = g_astScenePipeParam[u8Index].stDynamicFps.Fps[u32ExpLevel];
            ...
            CHECK_SCENE_RET(s32Ret);
            stVencChnAttr.stRcAttr.stH265Cbr.fr32DstFrameRate = g_astScenePipeParam[u8Index].stDynamicFps.Fps[u32ExpLevel];
            stVencChnAttr.stRcAttr.stH265Cbr.u32SrcFrameRate = g_astScenePipeParam[u8Index].stDynamicFps.Fps[u32ExpLevel];
            stVencChnAttr.stRcAttr.stH265Cbr.u32Gop = g_astScenePipeParam[u8Index].stDynamicFps.Fps[u32ExpLevel]*2;
            s32Ret = HI_MPI_VENC_SetChnAttr(VeChn,&stVencChnAttr);
            CHECK_SCENE_RET(s32Ret);  
            
            u32LastExpLevelLtH = u32ExpLevel;
        }
    }
    else if(u64LastExposure > u64Exposure)
        {
        u32ExpLevel = SCENE_GetLevelLtoH_U32(u64Exposure, g_astScenePipeParam[u8Index].stDynamicFps.u8FPSExposureCnt, g_astScenePipeParam[u8Index].stDynamicFps.au32ExposureLtoHThresh);
        if(u32ExpLevel == u32LastExpLevelHtL)
        {
            return HI_SUCCESS;
        }
        else
        {
            ...
            u32LastExpLevelHtL = u32ExpLevel;
        }
    }
...
{
    if (HI_TRUE != g_astScenePipeParam[u8Index].stModuleState.bDynamicLinearDrc || u64Iso == u64LastIso)
    {
        return HI_SUCCESS;
    }
...
{
    if (HI_TRUE != g_astScenePipeParam[u8Index].stModuleState.bDynamicBLC || u64LastExposure == u64Exposure)
    {
        return HI_SUCCESS;
    }
...
HI_S32 HI_SCENE_Set3DNR(VI_PIPE ViPipe, const HI_SCENE_3DNR_S* pst3Nrx, HI_U8 u8Index)
{
    ...
    {
        printf("checkxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n");
