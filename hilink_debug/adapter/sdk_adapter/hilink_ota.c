...
{
    log_debug("HilinkOtaStartProcess");
    /* 厂商实现此接口 */
    return RETURN_OK;
}
...
{
    log_debug("HilinkNotifyOtaStatus");
    /* 厂商实现此接口 */
    return RETURN_OK;
}
...
{
    log_debug("HILINK_GetUpdateFilePath");
    /* 厂商实现此接口 */
    return RETURN_OK;
}
