...
CFLAGS+= -Wall -DUSE_LIBUV=0 -DUSE_LIBEVENT=0
BASE_PATH=src/dev_model/app
LDFLAGS += -L$(BASE_PATH)/libevent_rk3308/lib
LDFLAGS	+= -Wl,--start-group	\
		-Wl,-Bstatic -levent_core -levent  -levent_pthreads  -levent_extra -levent_openssl	\
		-Wl,-Bdynamic -lDeviceIo -lasound	\
		-Wl,--end-group

SOURCE_FILES= app/*.c app/src/*.c app/src/cJSON/*c app/src/rk3308/*c app/src/frame/*c app/src/local/*c app/src/cloud/*c
LIB_SRCS_EXCLUDE         += $(SOURCE_FILES) 
SRCS_linkkit-app-gateway := $(SOURCE_FILES)
$(call Append_Conditional, TARGET, linkkit-app-gateway, DEVICE_MODEL_GATEWAY, BUILD_AOS NO_EXECUTABLES)
