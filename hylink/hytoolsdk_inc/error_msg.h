...
#define SceneAddErr                -287   //! Scene addition failure.
#define SceneDelErr                -288   //! Scene deletion failed.
#define SceneSetErr                -289   //! Scene setup failed.
#define SceneGetErr                -290   //! Scene acquisition failed.
...
#define SceneAddErrMsg             "Scene addition failure."
#define SceneDelErrMsg             "Scene deletion failed."
#define SceneSetErrMsg             "Scene setup failed."
#define SceneGetErrMsg             "Scene acquisition failed."
